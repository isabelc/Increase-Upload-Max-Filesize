...
# main config
PLUGINSLUG="increase-upload-max-filesize" # returns basename of current directory
CURRENTDIR=`pwd`
MAINFILE="increase-upload-max-filesize.php" # this should be the name of your main php file in the wordpress plugin
